...
public class Persona {
	...
	/*
	 * Metodo que permite validar un DNI
	 */
	public static boolean validarNif(String nif) {

		int longitud = 9;
		// A partir de Java SE 8, aunque estas variables no son
		// final, la JVM las trata como tal, y podemos asi usarlas
		// en la clase anonima.
		...
		//Clase local, a un metodo "validarNif()", que nos ayuda a validar el NIF
		class Nif {
			...
			//M�TODO QUE DEVUELVE EL DNI V�LIDO
			//PARA EL CONJUNTO DE N�MEROS
